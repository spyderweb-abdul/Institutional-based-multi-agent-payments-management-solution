...
// Original PHP code by Chirp Internet: www.chirp.com.au
 ...
 $fetch = $pgdb->query("SELECT a.admNo AS ADMISSION_NO, a.trans_id AS INVOICE_NO, a.rrr AS RRR, a.fullName AS DEPOSITOR, b.amount AS AMOUNT_PAID, a.deptName AS DEPT, a.level AS LEVEL
                       FROM fees_order AS a INNER JOIN fees_summary AS b ON b.admNo = a.admNo 
					   WHERE a.deptName = '$deptName' AND a.payment_status = '$status' AND a.session = '$session' 
