  ...
  if($mySubstr == '01')
    {
	   ...
	   $sql = $matdb->query("
	   SELECT * FROM ".TBL_PAYMENTS." AS a 
	   INNER JOIN ".TBL_BIODATA." AS b 
	   ON b.admNo = a.admNo 
	   WHERE a.invoiceno = '$orderID' OR a.rrr = '$orderID'");	 
	   $mt = mysqli_fetch_array($sql);	
...
elseif($mySubstr == '02')
{
	   ...
	   $sql = $matdb->query("
	   SELECT * FROM ".TBL_HOSTEL_PAYMENTS." AS a 
	   INNER JOIN ".TBL_BIODATA." AS b 
	   ON b.admNo = a.admNo 
	   WHERE a.invoiceno = '$orderID' OR a.rrr = '$orderID'");	 
	   $mt = mysqli_fetch_array($sql);	
...
*/
elseif($mySubstr == '03' || $mySubstr == '04' || $mySubstr == '05' || $mySubstr == '06' || $mySubstr == '07' || $mySubstr == '08' || $mySubstr == '09' || $mySubstr == '10'
       || $mySubstr == '11' || $mySubstr == '12' || $mySubstr == '13' || $mySubstr == '14' || $mySubstr == '15' || $mySubstr == '16' || $mySubstr == '17'
	   || $mySubstr == '18' || $mySubstr == '19' || $mySubstr == '20' || $mySubstr == '21' || $mySubstr == '22' || $mySubstr == '23' || $mySubstr == '24')
{
	   
	   $sql = $paydb->query("
	   SELECT * FROM ".TBL_PAYMENTS_RECORD." WHERE orderID = '$orderID'");	 
	   $mt = mysqli_fetch_array($sql);	
