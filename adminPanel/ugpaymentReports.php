...
<ul class="nav nav-pills">
  ...
  <li><a data-toggle="pill" href="#menu4">PAYMENT BY PROGRAMME</a></li>
</ul>
...
<!-- 4th TAB PILLS -->
 <div id="menu3" class="tab-pane fade">
     <br/>
  <hr noshade="noshade" />
    <h5>UG Payment By Faculty </h5>
    <p>
    
    <div id="val4"> </div>
   <form name="ug_fac" id="ug_fac">
     <table border="0" cellspacing="5" cellpadding="5">
     <tr>
    <td>            <div class="input-group">
                    <span class="input-group-addon styleTb"><b class="glyphicon glyphicon-folder-open"></b></span>
...
<!-- 5th TAB PILLS -->
 ...
 <br/>
 <hr noshade="noshade"  />
    <h5>UG Payment Breakdown by Programmes</h5>
    <p>
    
     <div id="val5"> </div>
   <form name="ug_prog" id="ug_prog">
     <table border="0" cellspacing="5" cellpadding="5">
     <tr>
    <td>            <div class="input-group">
                    <span class="input-group-addon styleTb"><b class="glyphicon glyphicon-folder-open"></b></span>
...
//UG Fees Item Breakdown	
	 $("#breakdown").click(function(){
	   ...
	   {
		   $("#val").empty();
		   $(".ugbreakdown").html('<img src="../images/pleaseWait3.gif" /> Please Wait...');
		dataString = $("#ug").serialize();	
		$.ajax({
    				type: "POST",
					url: "ajaxCalls/ajaxUgBreakdown.php",
					data: dataString,
					dataType: 'html',
        			success: function(msg)
					{
						$(".ugbreakdown").empty();
						$(".ugbreakdown").html(msg);
	...
	//Payment By Faculty	
	 $("#faculty").click(function(){
	   ...
	   {
		   $("#val4").empty();
		   $(".ugfac").html('<img src="../images/pleaseWait3.gif" /> Please Wait...');
		dataString = $("#ug_fac").serialize();	
		$.ajax({
    				type: "POST",
					url: "ajaxCalls/ajaxUgFacultyBreakdown.php",
					data: dataString,
					dataType: 'html',
        			success: function(msg)
					{
	...
	//Payment By Programme	
	 $("#programme").click(function(){
	   ...
	   {
		   $("#val5").empty();
		   $(".ugprog").html('<img src="../images/pleaseWait3.gif" /> Please Wait...');
		dataString = $("#ug_prog").serialize();	
		$.ajax({
    				type: "POST",
					url: "ajaxCalls/ajaxUgProgBreakdown.php",
					data: dataString,
					dataType: 'html',
        			success: function(msg)
					{
