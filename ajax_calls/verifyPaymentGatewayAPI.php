...
payment_notification($user_name, $user_email, $user_phone, $session, $gateway_name, $status, $setup_name, $userId, $invoice, $merchant_name, $amount, $rrr);	
		...
		{ 		
			echo '<div class="alert alert-success">RRR Generated Successfully <br/>';
		...
		{ 		
			echo '<div class="alert alert-danger"> <h6> <strong>Your Transaction was not Successful</strong> <br/>';
			...
			echo '<strong>Reason:</strong> '.$response_message.'</h6></div>';
			...
			echo '<br/><h6> <i class="fa fa-angle-double-right"> </i> Click <a href="'.$_SERVER['HTTP_REFERER'].'"> HERE </a> to go back to home page. </h5>';
        }
...
{
			echo '<p class="response-div grad"> Wrong Final CheckSum <br/>';
			echo $finalcheck. '<br/>';
