 ...
 echo '<div class="row"><div class="col-md-6"> 
        <div class="input-group">
           <span class="input-group-addon"><i class="fa fa-list-alt"></i></span>
             <select name="setupId" id="setupId" class="form-control pay-detail-form" onchange="display_session_ver()" >
...
{
		echo '<button class="btn btn-danger btn-sm">User not found or No transaction(s) to verify </button>';
