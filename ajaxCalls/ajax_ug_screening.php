...
if(mysqli_num_rows($sql) > 0)
{
	...
	$invoice = '31'.rand(1000, 7777).rand(4000, 9865);
	$amt = '2000';
	$payment_status = 'PENDING';
	
	$descr = 'SCREENING FEES - '.$invoice;
	$des = 'SCREENING FEES';
	$payType = 'SCREENING FEES';
	
	$session = '2016/2017';
	
$chk = $paydb->query("SELECT * FROM ".TBL_PAYMENTS_RECORD." WHERE userId = '$userId' AND paymentType = 'SCREENING FEES' AND session = '2016/2017' ");
