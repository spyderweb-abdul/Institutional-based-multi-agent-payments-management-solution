...
$r =   $sql->fetch_array();
	...
	$des = 'TRANSCRIPT PROC. (FOREIGN) FEE';
	$payType = 'TRANSCRIPT PROCESSING (FOREIGN)';
	...
	$orderID = '08'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'TRANSCRIPT PROC. (FOREIGN) FEE - '.$invoice;
