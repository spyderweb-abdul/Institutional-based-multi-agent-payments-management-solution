...
$r =  $sql->fetch_array();
	...
	$des = 'TRANSCRIPT PROC. (LOCAL) FEE';
	$payType = 'TRANSCRIPT PROCESSING (LOCAL)';
	...
	$orderID = '07'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'TRANSCRIPT PROC. (LOCAL) FEE - '.$invoice;
