...
$r =   $sql->fetch_array();
	...
	{
		$email = 'payments@udusok.edu.ng';
	}
	$amt = '20000';
	
	$des = 'CHANGE OF COURSE FEE';
	$payType = 'CHANGE OF COURSE';
	...
	$orderID = '04'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'CHANGE OF COURSE FEE - '.$invoice;
