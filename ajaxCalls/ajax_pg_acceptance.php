...
$sql = $pgdb->query("SELECT * FROM ".TBL_PG_ADM." WHERE app_no = '$userId'");
$r =   $sql->fetch_array();
...
if(mysqli_num_rows($sql) > 0)
{
	...
	$des = 'PG ACCEPTANCE FEE';
	$payType = 'PG ACCEPTANCE';
	...
	$orderID = '12'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'PG ACCEPTANCE FEE - '.$invoice;
...
{
	echo '<div class="alert alert-danger styleTb"> No Match for this Application No. Kindly check the App. No. you have entered. </div>';
}
