...
if(isset($_GET['jambno']))
{
	...
	$sql = mysql_query("SELECT orderID, paymentType FROM payments_record WHERE userId = '$userId' ORDER BY paymentType", $mydb);
	...
	{
		echo 'There is no match for this Jamb Number. Kindly generate payment invoice and pay before verification. <a href="http://admissions.udusok.edu.ng/verifyPayment.php"> Back to previous </a>';
		exit();
	}
}
