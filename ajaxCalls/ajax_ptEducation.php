...
$r =   $sql->fetch_array();
	...
	$des = 'B.ED PART-TIME SALES OF FORMS';
	$payType = 'B.ED PART-TIME FORM';
	...
	$orderID = '28'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'B.ED PART-TIME SALES OF FORMS - '.$invoice;
