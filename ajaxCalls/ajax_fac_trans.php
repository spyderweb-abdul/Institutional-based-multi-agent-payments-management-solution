...
$r =   $sql->fetch_array();
	...
	$des = 'INTER-FACULTY TRANSFER FEE';
	$payType = 'INTER-FACULTY TRANSFER';
	...
	$orderID = '16'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'INTER-FACULTY TRANSFER FEE - '.$invoice;
