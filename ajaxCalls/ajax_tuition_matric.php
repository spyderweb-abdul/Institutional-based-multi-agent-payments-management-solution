...
if(mysqli_num_rows($sql) > 0)
{
	...
	$invoiceno = '01'.rand(1000, 9999).rand(3000, 8999);
	$amt = '50000';
	$payment_status = 'PENDING';
	
	
	$chk = $matdb->query("SELECT * FROM ".TBL_PAYMENTS." WHERE admNo = '$userId'");
	$ch = $chk->fetch_array();
	...
	$descr = 'UDUS MATRIC TUITION FEES - '.$invoice;
	$des = 'UDUS MATRIC TUITION FEES';
	...
	{	
	$ins = $matdb->query("INSERT INTO ".TBL_PAYMENTS." (invoiceno, admNo, amt, payment_status, descr) VALUES ('$invoiceno', '$userId', '$amt', '$payment_status', '$descr')");
	}
