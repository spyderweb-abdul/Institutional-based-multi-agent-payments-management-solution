...
$r =  $sql->fetch_array();
	...
	$des = 'BSC ACCOUNTING (PART TIME) FORM';
	$payType = 'BSC ACCOUNTING (PT)';
	...
	$orderID = '11'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'BSC ACCOUNTING (PART TIME) FORM - '.$invoice;
