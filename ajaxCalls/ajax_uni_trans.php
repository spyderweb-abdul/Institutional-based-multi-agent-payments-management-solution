...
$r  =  $sql->fetch_array();
	...
	$des = 'INTER-UNIVERSITY TRANSFER FEE';
	$payType = 'INTER-UNIVERSITY TRANSFER';
	...
	$orderID = '17'.substr(date('Y'), -2).rand(1000, 9999).rand(3000, 8999);
	...
	$descr = 'INTER-UNIVERSITY TRANSFER FEE - '.$invoice;
