...
<p style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size:14px; font-weight:500"> This is your payment invoice details for: %setup_name%
<br/><br/>

<strong style="color:#900"> PAYER ID: %userId%  </strong><br/><br/>
<strong style="color:#900"> INVOICE NO: %invoice% </strong><br/>
 ...
 <ul>
  ...
  <p><i class="fa fa-toggle-right"></i> PAYABLE TO: %merchant_name%  </p>
